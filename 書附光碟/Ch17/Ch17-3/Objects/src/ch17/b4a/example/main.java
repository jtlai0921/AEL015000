...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "ch17.b4a.example", "ch17.b4a.example.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "ch17.b4a.example", "ch17.b4a.example.main");
...
Debug.StartDebugging(mostCurrent.activityBA, 17421, new int[] {2}, "89e8a13d-b35f-4a1a-85bd-3132755ca61b");}
